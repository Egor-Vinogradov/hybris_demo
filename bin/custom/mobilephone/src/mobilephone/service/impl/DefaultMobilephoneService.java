...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMobilephoneService.class);
	...
	{
		return DefaultMobilephoneService.class.getResourceAsStream("/mobilephone/sap-hybris-platform.png");
	}
